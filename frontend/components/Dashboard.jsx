...
export default function Dashboard() {
  const { user, logout, messages, sendMessage, isLoading, clearMessages } =
    useAuthStore();
                  ...
                  {msg.role === "user" ? (
                    <div className="flex gap-3 items-start">
                      ...
                      <div className="flex-1 pt-1.5">
                        <div className="text-sm font-medium mb-1.5 text-zinc-400">
                          You
                        </div>
      ...
      <div className="px-4 py-6 bg-gradient-to-t from-black via-black to-transparent">
        <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
          <div className="relative">
            <div
              className={`relative rounded-2xl bg-zinc-900 border transition-all duration-300 ${
                focused
                  ? "border-zinc-700 shadow-lg shadow-zinc-900/50"
                  : "border-zinc-800"
              }`}
            >
              <textarea
